...
export default function InstagramLayout({
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-0 md:p-8">
      ...
      */}
      <div className="relative w-full h-[100dvh] md:w-[414px] md:h-[736px] bg-[#030303] overflow-hidden md:rounded-[40px] md:shadow-2xl md:shadow-white/5 md:border-[8px] md:border-neutral-900 mx-auto">
        {children}
      </div>
    </div>
  );
